...
import {
  filtersVar, filtersPriceVar, filtersRarityMinVar, filtersRarityMaxVar, filtersButtonVar,
...
export default function RarityPage() {
  ...
  useEffect(() => {
    ...
    getCollectionInfor();
    // const items = collectionService().getAllItems(address);
  },[slug])
  ...
  }, [paginationLimit, filter, setFiltered, sortingDirection, filterButton, filterPrice, filterRarityMin, filterRarityMax])
  ...
  const loadMore = useCallback(
    ...
    [addItems, filter, offset, paginationLimit, sortingDirection, filterButton, filterPrice, filterRarityMin, filterRarityMax]
  )
  ...
  return (
    ...
    <Sidebar sidebarChange = {sidebarChange} handleFilter = {filtersVar} handleFilterButton = {filtersButtonVar} handleFilterPrice = {filtersPriceVar} handleFilterRarityMin = {filtersRarityMinVar} handleFilterRarityMax = {filtersRarityMaxVar} traits={collectionInfor?.traits} count={collectionInfor?.count} />
