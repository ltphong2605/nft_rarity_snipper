...
const SubMenu = ({ item, traits, handleButton, handlePrice, handleRarityMin, handleRarityMax, count }) => {
          ...
          {(item.title==='PRICE')&&
            <SearchDiv>
              <div style={{margin: '0 0 10px 20px'}}>
                <S.ShortInput id="min_price" onChange = {(e) => (/^[0-9\b]+$/.test(e.target.value) || e.target.value == '') && setPriceMin(e.target.value)} onKeyPress={(e) => handlePriceKeyPress(e)} value={price_min} type='text' placeholder='Min' />
                <span>to</span>
                <S.ShortInput id="max_price" onChange = {(e) => (/^[0-9\b]+$/.test(e.target.value) || e.target.value == '') && setPriceMax(e.target.value)} onKeyPress={(e) => handlePriceKeyPress(e)} value={price_max} type='text' placeholder='Max'/>
              </div>
            </SearchDiv>
          }
          {(item.title==='RARITY')&&
            <SearchDiv>
              <div style={{margin: '0 0 10px 20px'}}>
                <S.ShortInput onChange = {(e) => (/^[0-9\b]+$/.test(e.target.value) || e.target.value == '') && setRarityMin(e.target.value)} onKeyPress={(e) => handleRarityMinKeyPress(e)} value={rarity_min} type='text' placeholder='Min' />
                <span>to</span>
                <S.ShortInput onChange = {(e) => (/^[0-9\b]+$/.test(e.target.value) || e.target.value == '') && setRarityMax(e.target.value)} onKeyPress={(e) => handleRarityMaxKeyPress(e)} value={rarity_max} type='text' placeholder='Max' />
              </div>
            </SearchDiv>
          }
