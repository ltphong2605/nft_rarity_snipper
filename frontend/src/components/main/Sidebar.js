...
`;
const Sidebar = ({sidebarChange, handleFilter, handleFilterButton, handleFilterPrice, handleFilterRarityMin, handleFilterRarityMax, traits, count}) => {
        ...
        <SidebarNav sidebar={sidebar}>
          <SidebarWrap>
            ...
            {sidebar&& SidebarData.map((item, index) => {
              return <SubMenu item={item} key={index} handleButton={handleFilterButton} handlePrice={handleFilterPrice} handleRarityMin={handleFilterRarityMin} handleRarityMax={handleFilterRarityMax} traits={traits} count={count} />;
            })}
          </SidebarWrap>
        </SidebarNav>
